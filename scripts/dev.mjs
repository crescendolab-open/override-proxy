...
/**
 * Dev wrapper: starts nodemon and forwards CLI args to `override-proxy serve`.
 *
 * Usage: node scripts/dev.mjs [--config=./override-proxy.config.ts]
...
const nodemonArgs = [];
const needsOverride = args.length > 0;
